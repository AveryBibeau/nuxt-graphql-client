...
Default behavior `inline` inlines fragment types in generated queries. `combine` uses fragment type references without inlining. See [GraphQL Code Generator documentation](https://the-guild.dev/graphql/codegen/plugins/typescript/typescript#inlinefragmenttypes)
